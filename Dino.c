...
int main(void)
{
    ...
    Character chars[NUM_CHARACTERS] = {
        {"Reimu Hakurei","re.png"},
        {"Marisa Kirisame","Ma.png"},
        {"Rumia","Ru.png"},
        {"Daiyousei","3pixels_char1.png"},
        {"Cirno", "9.png"},
        {"Hong Melling","Mel.png"},
        {"Koakuma","SecondOne.png"},
        {"Patchouli Knowledge","Book.png"},
        {"Sakuya Izayoi", "Knife.png"},
        {"Remillia Scarlet","Remi.png"},
        {"Flandre Scarlet","TasyFoodName.png"},
        {"Letty Whiterock","TasyFoodName.png"},
        {"Chen","Cat.png"},
        {"Alice Margatroid","Aris.png"},
